(() => {
  ...
  const infoSectionsRef = script?.dataset.infoSectionsRef || "kw-info-accordion-dev";
  const infoSectionsVersion = script?.dataset.infoSectionsVersion || "20260628-tight-spacing-1";
  ...
  const resources = [
    ...
    { type: "css", key: "kw-info-sections-css", href: url(infoSectionsRef, "fourthwall/info-sections/kw-info-sections.css", infoSectionsVersion) },
    ...
    { type: "js", key: "kw-info-sections-js", src: url(infoSectionsRef, "fourthwall/info-sections/kw-info-sections.js", infoSectionsVersion) },
